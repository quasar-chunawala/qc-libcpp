...
bool string::is_long_string() { return !is_short_string(); }
bool string::is_long_string() const { return !is_short_string(); }

// ============================================================
// Size helpers
// ============================================================

size_t string::get_short_size() { return m_data.s.m_size >> 1; }
size_t string::get_short_size() const { return m_data.s.m_size >> 1; }
void string::set_short_size(size_t sz) {
	m_data.s.m_size = (sz << 1) | string_short_mask;
}
size_t string::get_long_size() { return m_data.l.m_size; }
size_t string::get_long_size() const { return m_data.l.m_size; }
void string::set_long_size(size_t sz) { m_data.l.m_size = sz; }
...
void string::set_sso_flag() { m_data.s.m_size |= string_short_mask; }
...
size_t string::get_long_capacity() { return m_data.l.m_capacity; }
size_t string::get_short_capacity() { return string_short::capacity; }
...
bool string::is_full() { return size() == capacity(); }
...
bool string::empty() { return size() == 0; }
...
char &string::front() { return data()[0]; }
char &string::back() { return data()[size() - 1]; }
